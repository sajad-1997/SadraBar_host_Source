...
class Bijak(UserTrackingModel):
    ...
    unloading_fee = models.DecimalField(max_digits=15, decimal_places=0, blank=True, null=True, verbose_name="هزینه تخلیه")
    scale_fee = models.DecimalField(max_digits=15, decimal_places=0, blank=True, null=True, verbose_name="هزینه باسکول")
